  ...
  <div>
    ...
    <v-container style="margin-top:64px">
      <v-card class="mt-5">
        ...
        <v-card-title>
          <div
            style="width:100%; font-size:1.75em;"
            class="text-center"
          >
        ...
        <v-card-text style="font-size:1.5em; text-align: center;">
              ...
              <div class="brandImage">
                ...
                >
                  ...
                  <span>The Muse Terpsichore by
                    <a
                      href="#"
                      @click="goTo('https://www.flickr.com/photos/45238035@N02/5065121595')"
                    >
                      Becante
                    </a>
                    is licensed under
          ...
          <p>
            For questions, comments, and troubleshooting, contact
            <a href="mailto:terpsi_support@umd.edu">
              terpsi_support@umd.edu
            </a>
          </p>
        </v-card-text>
      </v-card>
